...
export const b2cPolicies = {
  ...
  authorities: {
    signUpSignIn: {
      authority:
        "https://login.microsoftonline.com/9821a53a-70e9-4dc4-a4f6-726cf7d5be76",
    },
    forgotPassword: {
      authority:
...
export const msalConfig = {
  auth: {
    clientId: "cda14bbd-b269-4fb2-8dbb-dccba9812b8c", // This is the ONLY mandatory field that you need to supply.
